...
void main(){
	...
	SpawnLevelObject(teapot, vec3(0, 0, 0), quat(1.0f, 0.5f, 0.2f, 0.0f), vec3(1.0f), vec4(0.1f, 0.3f, 0.6f, 1.0f));
	
	
	/*
	SpawnLevelObject(teapot, vec3(50, 0, 0), quat(1.0f, 0.0f, 0.0f, 0.0f), vec3(1.0f), vec4(0, 0.2f, 0, 1));
	SpawnLevelObject(bunny, vec3(0, 0, 0), quat(1.0f, 0.0f, 0.0f, 0.0f), vec3(0.2f), vec4(1.0f, 0.0f, 0.0f, 1.0f));
