...
void main(){
	...
	SpawnLevelObject(cube, vec3(0, 0, 0), quat(1.0f, 0.0f, 0.0f, 0.0f), vec3(15.0f), vec4(1.0f, 1.0f, 1.0f, 1.0f));
	...
	for(int x = 0; x < size; x++){
		for(int y = 0; y < size; y++){
			SpawnPhysicsObject(cube, vec3(x + 20, 50, y), quat(1.0f, 0.0f, 0.0f, 0.0f), vec3(3), vec4(x / size, 1.0f - (y / size), 0.0f, 1.0f), 2.0f);
		}
	}
